...
A compact SQL project tracking free-trial conversions, customer subscription journeys, and recurring revenue metrics for a digital streaming startup.
...
```
#### 10. WIP: Can you further breakdown this average value into 30 day periods (i.e. 0-30 days, 31-60 days etc)
```sql
WITH
    trial_to_annual_cte
    AS
...
## Reflections
Working through this Foodie-Fi dataset was an incredible exercise in tracking customer journeys through data. I loved the challenge of using SQL window functions to catch exact moments when users upgraded, downgraded, or canceled their plans. It reinforced how powerful clean database logic is for unlocking critical business metrics like customer retention and time-to-conversion.
